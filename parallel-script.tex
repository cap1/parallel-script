...
\label{sub:data_task_parallelism}
	...
	Data paralellism is used,
	when the professor assigns each TA 100 exams to correct.
	Task parallelism is peformed,
	when each of the TA is assigned a certain range of questions in the exams to correct.
	For examples in Perlcode see Listing \ref{code:dataParalellism} and \ref{code:taskParalellism}.
...
Their lightweightedess allows to create them fast and with little overhead.
